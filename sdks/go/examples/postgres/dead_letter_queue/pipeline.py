...
def run(argv=None):
    ...
    parser.add_argument("--username", default="scotty", help="PostgreSQL username")
    ...
    with beam.Pipeline(options=pipeline_options) as p:
        ...
        clean_result = validated.clean | "SinkCleanPayments" >> WriteToPostgresIO(
        ...
        validation_dlq | "SinkValidationDLQ" >> WriteToPostgresIO(
            host=known_args.host,
            port=known_args.port,
            database=known_args.database,
            username=known_args.username,
