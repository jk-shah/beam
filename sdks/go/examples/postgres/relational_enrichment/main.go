...
func main() {
	...
	sampleOrders := []Order{
		...
		{OrderID: 1003, CustomerID: "CUST-1", Item: "BigQuery Slots", Amount: 1200.00, OrderedAt: now},
		{OrderID: 1004, CustomerID: "CUST-3", Item: "Cloud Spanner Node", Amount: 950.00, OrderedAt: now},
	}
