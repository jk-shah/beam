...
def run():
    ...
    parser.add_argument("--username", default="beam_cdc", help="Database user")
    parser.add_argument("--password", default="beam_cdc_pass", help="Database password")
    ...
    with beam.Pipeline(options=pipeline_options) as p:
        ...
        _ = records | "SinkToHATarget" >> WriteToPostgres(
            host=known_args.endpoint,
            port=known_args.port,
            database=known_args.database,
            username=known_args.username,
