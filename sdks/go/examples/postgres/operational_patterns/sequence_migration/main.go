...
func init() {
	...
	beam.RegisterDoFn(&logReconciliationFn{})
}

type logReconciliationFn struct{}

func (fn *logReconciliationFn) ProcessElement(sql SequenceReconciliationSQL) {
...
func main() {
	...
	beam.ParDo0(s, &logReconciliationFn{}, resetQueries)
